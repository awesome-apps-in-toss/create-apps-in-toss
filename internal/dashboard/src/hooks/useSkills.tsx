...
// GitHub Pages demo fallback — 서버가 없을 때 로드맵 7단계 기본 shape만 흉내 낸다.
...
const DEMO_SKILLS: SkillMeta[] = [
  ...
  { id: 'ait-build', name: 'ait-build', description: '빌드 + 콘솔 업로드 안내', mode: 'automated', step: 7, label: '빌드', produces: '.ait 번들', requires: ['ait-review'], inputs: [], outputs: [], idempotencyKey: 'ait-build' },
];
